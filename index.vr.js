...
export default class PanoramicRoadTrip extends React.Component {
  ...
  render() {
    const states = {Arizona: "Arizona", NewHampshire: "New Hampshire", California: "California", Hawaii: "Hawaii", Texas: "Texas"}
    ...
    return (
      <View>
        ...
        <View
          ...
          <Title/>
          <TextBoxes stateClicked={this.stateClicked} states={states}/>
        </View>
      </View>
    );
  }
